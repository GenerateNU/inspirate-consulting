...
// Repository methods can take in a QueryInterface object and run any of these methods either on
// a standalone connection, or in a transaction
// ex)
// func (r *Repository) GetByID(ctx context.Context, db QueryInterface, ud uuid.UUID) (*models.User, error) {
